...
use solar_clmm::accounts as raydium_accounts;
use solar_clmm::instruction as raydium_instruction;
use solar_clmm::states::{
...
pub fn initialize_reward_instr(
    ...
    let instructions = program
        ...
        .args(raydium_instruction::InitializeReward {
            param: solar_clmm::instructions::InitializeRewardParam {
                open_time,
                end_time,
